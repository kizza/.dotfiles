...
" nnoremap <silent> <Tab> :bnext<CR>   Disable while co-pilot mappings figured out
...
nnoremap <silent> <leader>gr :Remark<CR>
vnoremap <silent> <leader>gr :Remark<CR>
nnoremap <silent> <leader>gR :Remarks<CR>
nnoremap <silent> <leader>gd :RemarkDelete<CR>
