  ...
  },
  {
    ...
    config = function()
      require('gitsigns').setup {
        -- Whatever `:GitBase` or a parked rebase wants, so every buffer opened from here attaches
        -- already pointed at it. Buffers open before this ran are caught by the late-attach re-point.
